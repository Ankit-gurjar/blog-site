...
module.exports.getPostById = expressAsyncHandler(async (req, res) => {
  try {
...
module.exports.addComment = expressAsyncHandler(async (req, res) => {
  try {
    const post = await Post.findById(req.params.id);
    const comment = {
      text: req.body.text,
...
module.exports.getAllPosts = expressAsyncHandler(async (req, res) => {
  try {
...
module.exports.updateAvatar = expressAsyncHandler(async (req, res) => {
  try {
